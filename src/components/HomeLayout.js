...
import { iHeader } from './header/iHeader.js';
  ...
  render() {	  
    ...
    return (
	  ...
	  <Header className={style.header}>  
		<Link to="/" className={style.link}>宁波麦智信息有限公司</Link>
		  <iHeader style={{height:200,display:'block',position:'static',zIndex:9999}} />
		...
		<Layout>
          ...
          <Content style={{ margin: 15, padding: 24, background: '#fff', minHeight: 280 }}>
           {children}
          </Content>
		</Layout>        
      </Layout>
